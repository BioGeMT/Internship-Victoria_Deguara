...
#defining the seed-type functions (from first task)
...
#definig the match-checking function
...
def seed_match_df():
    ...
    dfi = pd.read_csv(args.input_file, sep='\t')[["gene", "noncodingRNA", "label"]]
